...
2. **Pruebas:** Hacer PR a `develop` para validación
3. **Producción:** Merge a `main` para despliegue automático

---

## **📞 Soporte**

- **📧 Email:** soporte@dosw.com
- **🐛 Issues:** [GitHub Issues](https://github.com/tu-usuario/master-chef-api/issues)
- **📚 Documentación:** [Swagger UI](https://master-chef-api.azurewebsites.net/swagger-ui.html)
...
## **👨‍💻 Desarrollo por DOSW Company**

**¡Disfruta cocinando con Master Chef Celebrity!** 🍳🎉

---

## **🔗 Enlaces Rápidos**

- [🌐 API en Producción](https://master-chef-api.azurewebsites.net)
- [📚 Swagger UI](https://master-chef-api.azurewebsites.net/swagger-ui.html)
- [🔄 GitHub Actions](https://github.com/tu-usuario/master-chef-api/actions)
- [🐛 Reportar Issues](https://github.com/tu-usuario/master-chef-api/issues)
